...
/**
 * Classe responsável por armazenar os processos de controle de tela de Venda
 *
...
public class VendaController {
    ...
    /*
    * Método para iniciar a tela Confirma Venda Prazo
    */
    public void iniciaConfirmaVendaPrazo() {
    ...
    public void bloqueioInicial() {
        ...
        tela.getTfDesconto().setEditable(false);
        tela.getTfDesconto2().setEditable(false);
        
        //desabilitando o combo box
        tela.getCbFuncionario().setEnabled(false);
        tela.getCbCliente().setEnabled(false);
